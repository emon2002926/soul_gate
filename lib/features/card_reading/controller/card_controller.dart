...
class CardController extends GetxController {
  // Base URL for API
  static const String baseUrl = 'https://sofiai.dsrt321.online/api';
  ...
  // Selected stack index (for visual highlight on arc cards)
  ...
  Future<void> shuffleAndDivideCards() async {
    ...
    try {
      ...
      if (response != null && response['success'] == true) {
        ...
        // Wait a moment then spread the cards
  ...
  // Highlight arc card only (no card selection for reading)
