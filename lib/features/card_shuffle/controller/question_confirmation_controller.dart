    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          // );
          CustomeSnackbar.error('Failed to load questions');
        }
      } else {
      ...
      //   colorText: Colors.white,
      // );
      CustomeSnackbar.error('Network error: $e');
    } finally {
...
class QuestionConfirmationController extends GetxController {
  ...
  void continueToReading(int readingTypeIndex, int deckIndex) {
    ...
    if (question.isEmpty) {
      ...
      //   borderRadius: 12,
      // );
      CustomeSnackbar.error('Please enter a question before continuing');
      return;
    }
